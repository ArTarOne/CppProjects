...
template <typename T>
std::string SettingsParser::convertToStr(T /*input*/) const
{
    throw
        "Unsupported type supplied, either change types, or write a correct conversion function for the template type.";
}

template <>
inline std::string SettingsParser::convertToStr<std::string>(
...
template <>
inline std::string SettingsParser::convertToStr<const char*>(
...
template <>
inline std::string SettingsParser::convertToStr<unsigned int>(
...
template <typename T>
T SettingsParser::convertToType(const std::string& /*input*/) const
{
    throw
        "Unconvertable type encountered, please use a different type, or define the handle case in SettingsParser.hpp";
}
...
template <>
inline unsigned int SettingsParser::convertToType<unsigned int>(
...
template <>
inline double SettingsParser::convertToType<double>(
    const std::string& input) const
{
    double value;
    std::stringstream ss(input);
...
template <>
inline float SettingsParser::convertToType<float>(
    const std::string& input) const
{
    float value;
    std::stringstream ss(input);
...
template <>
inline short SettingsParser::convertToType<short>(
    const std::string& input) const
{
    short value;
    std::stringstream ss(input);
...
template <>
inline std::string SettingsParser::convertToType<std::string>(
    const std::string& input) const
{
    return input;
}
...
template <typename T>
void SettingsParser::get(const std::string& key, T& value) const
{
 ...
 * separated by comma. The vector is cleared before it is filled.
 */
template <typename T>
void SettingsParser::get(const std::string& key, std::vector<T>& value) const
{
    auto it = m_data.find(key);
    if(it != m_data.end())
    {
...
template <typename T>
void SettingsParser::set(const std::string& key, const T value)
{
...
template <typename T>
void SettingsParser::set(const std::string& key, const std::vector<T> value)
{
